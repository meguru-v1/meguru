...
const SearchInterface = ({ onSearch }) => {
    ...
    return (
        <div
            className="glass-panel p-4 md:p-8 max-w-md w-full mx-auto relative z-10"
        >
            <div className="text-center mb-3 md:mb-8">
                <h1 className="text-xl md:text-3xl font-serif font-bold text-slate-800 mb-0.5 md:mb-2">Meguru</h1>
                <p className="text-slate-500 text-[10px] md:text-sm">あなたのための、特別なよりみち。</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
                ...
                <div className="space-y-1 md:space-y-2">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-slate-100/50 border border-slate-200 rounded-lg px-3 py-2 md:py-3 pl-9 focus:outline-none focus:ring-2 focus:ring-slate-900 transition-all font-medium text-slate-700 placeholder-slate-400 text-xs md:text-base"
                        />
                    ...
                    <div className="space-y-1 md:space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-slate-100/50 border border-slate-200 rounded-lg px-3 py-2 md:py-3 focus:outline-none focus:ring-2 focus:ring-slate-900 transition-all font-medium text-slate-700 placeholder-slate-400 text-xs md:text-base"
                            />
                        </div>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full btn-primary flex items-center justify-center gap-2 mt-2 md:mt-4 py-2.5 md:py-3 text-xs md:text-base"
                >
                    {isSearching ? (
